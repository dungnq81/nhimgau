...
<div class="section section-checkbox" id="section_base_slug_post_type">
    ...
    <div class="desc">Remove post-type base like <b>/product/*</b>, <b>/project/*</b> from post-type URLs. Example: default: <b>/product/sample-product/</b>
        - becomes: <b>/sample-product/</b></div>
	<?php
	...
	foreach ( $post_types as $post_type ) {
        ...
        <div class="option mb-20">
            <label class="controls">
                <input type="checkbox" class="checkbox" name="base_slug_post_type[]"
                       value="<?php echo esc_attr( $post_type->name ); ?>" <?php in_array_checked( $base_slug_post_type, $post_type->name ); ?>>
            </label>
...
<div class="section section-checkbox" id="section_base_slug_taxonomy">
	...
	foreach ( $taxonomies as $taxonomy ) {
        ...
        <div class="option mb-20">
            <label class="controls">
                <input type="checkbox" class="checkbox" name="base_slug_taxonomy[]"
                       value="<?php echo esc_attr( $taxonomy->name ); ?>" <?php in_array_checked( $base_slug_taxonomy, $taxonomy->name ); ?>>
            </label>
            <div class="explain"><?php echo $label; ?></div>
        </div>
	<?php } ?>

    <div class="desc !mt-30" style="color:#d63638">If encountering a 404 error, navigate to <b>Settings</b> -> <b>Permalinks</b>, and click
        "<b>Save Changes</b>".
    </div>
</div>
