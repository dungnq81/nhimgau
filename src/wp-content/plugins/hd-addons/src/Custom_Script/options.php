...
<div class="section section-textarea" id="section_html_footer">
    ...
    <div class="desc">Add custom scripts you might want to be loaded in the footer of your website. You need to have a SCRIPT tag around
        scripts.
    </div>
    <div class="option">
        <div class="controls">
...
<div class="section section-textarea" id="section_html_body_top">
    ...
    <div class="option">
        <div class="controls">
            <textarea class="textarea codemirror_html" name="html_body_top" id="html_body_top"
                      rows="4"><?php echo $html_body_top; ?></textarea>
        </div>
    </div>
</div>
<div class="section section-textarea" id="section_html_body_bottom">
    ...
    <div class="option">
        <div class="controls">
            <textarea class="textarea codemirror_html" name="html_body_bottom" id="html_body_bottom"
                      rows="4"><?php echo $html_body_bottom; ?></textarea>
        </div>
    </div>
</div>
