...
<div class="section section-text" id="section_recaptcha_v2_site_key">
    ...
    <div class="option">
        <div class="controls">
            <input value="<?php echo esc_attr( $recaptcha_v2_site_key ); ?>" class="input" type="text" id="recaptcha_v2_site_key"
...
<div class="section section-text" id="section_recaptcha_v2_secret_key">
    ...
    <div class="option">
        <div class="controls">
            <input value="<?php echo esc_attr( $recaptcha_v2_secret_key ); ?>" class="input" type="text" id="recaptcha_v2_secret_key"
...
<div class="section section-text" id="section_recaptcha_v3_site_key">
    ...
    <div class="desc">Use this site key in the HTML code your site serves to users. <a target="_blank"
                                                                                       href="https://developers.google.com/recaptcha/docs/v3">See
            client side integration</a></div>
    <div class="option">
        <div class="controls">
            <input value="<?php echo esc_attr( $recaptcha_v3_site_key ); ?>" class="input" type="text" id="recaptcha_v3_site_key"
...
<div class="section section-text" id="section_recaptcha_v3_secret_key">
    ...
    <div class="desc">Use this secret key for communication between your site and reCAPTCHA. <a target="_blank"
                                                                                                href="https://developers.google.com/recaptcha/docs/verify">See
            server side integration</a></div>
    <div class="option">
        <div class="controls">
            <input value="<?php echo esc_attr( $recaptcha_v3_secret_key ); ?>" class="input" type="text" id="recaptcha_v3_secret_key"
...
<div class="section section-text" id="section_recaptcha_v3_score">
    <label class="heading inline-heading"
           for="recaptcha_v3_score"><?php _e( 'reCAPTCHA human/bot threshold score', ADDONS_TEXT_DOMAIN ); ?></label>
    <div class="desc">reCAPTCHA v3 returns a score (1.0 most likely a good interaction, 0.0 most likely a bot). By default, you can use a
        threshold of 0.5.
    </div>
    <div class="option">
        <div class="controls">
            <input value="<?php echo esc_attr( $recaptcha_v3_score ); ?>" class="input !w-200" type="number" min="0.0" max="1.0" step="0.01"
                   id="recaptcha_v3_score" name="recaptcha_v3_score">
        </div>
    </div>
</div>
...
<div class="section section-checkbox" id="section_recaptcha_global">
    ...
    <div class="option">
        <div class="controls">
            <input type="checkbox" class="checkbox" name="recaptcha_global"
                   id="recaptcha_global" <?php echo checked( $recaptcha_global, 1 ); ?> value="1">
        </div>
