...
<div class="section section-checkbox" id="section_use_widgets_block_editor_off">
    ...
    <div class="option">
        <div class="controls">
            <input type="checkbox" class="checkbox" name="use_widgets_block_editor_off"
                   id="use_widgets_block_editor_off" <?php echo checked( $use_widgets_block_editor_off, 1 ); ?> value="1">
        </div>
...
<div class="section section-checkbox" id="section_gutenberg_use_widgets_block_editor_off">
    <label class="heading"
           for="gutenberg_use_widgets_block_editor_off"><?php _e( 'Disable Gutenberg widgets', ADDONS_TEXT_DOMAIN ); ?></label>
    <div class="option">
        <div class="controls">
            <input type="checkbox" class="checkbox" name="gutenberg_use_widgets_block_editor_off"
                   id="gutenberg_use_widgets_block_editor_off" <?php echo checked( $gutenberg_use_widgets_block_editor_off, 1 ); ?>
                   value="1">
        </div>
...
<div class="section section-checkbox" id="section_use_block_editor_for_post_type_off">
    ...
    <div class="option">
        <div class="controls">
            <input type="checkbox" class="checkbox" name="use_block_editor_for_post_type_off"
                   id="use_block_editor_for_post_type_off" <?php echo checked( $use_block_editor_for_post_type_off, 1 ); ?> value="1">
        </div>
...
<div class="section section-checkbox" id="section_block_style_off">
    ...
    <div class="option">
        <div class="controls">
            <input type="checkbox" class="checkbox" name="block_style_off"
                   id="block_style_off" <?php echo checked( $block_style_off, 1 ); ?> value="1">
        </div>
