...
<div class="section section-checkbox" id="remove_legacy_coupon">
    ...
    <div
        class="desc"><?php _e( 'Fixed WooCommerce Admin notice for removing legacy coupon menu does not disappear.', ADDONS_TEXT_DOMAIN ) ?></div>
    <div class="option">
        <div class="controls">
            <input type="checkbox" class="checkbox" name="remove_legacy_coupon"
                   id="remove_legacy_coupon" <?php echo checked( $remove_legacy_coupon, 1 ); ?> value="1">
        </div>
...
<div class="section section-checkbox" id="woocommerce_jsonld">
    ...
    <div class="option">
        <div class="controls">
            <input type="checkbox" class="checkbox" name="woocommerce_jsonld"
                   id="woocommerce_jsonld" <?php echo checked( $woocommerce_jsonld, 1 ); ?> value="1">
        </div>
...
<div class="section section-checkbox" id="woocommerce_default_css">
    ...
    <div class="option">
        <div class="controls">
            <input type="checkbox" class="checkbox" name="woocommerce_default_css"
                   id="woocommerce_default_css" <?php echo checked( $woocommerce_default_css, 1 ); ?> value="1">
        </div>
