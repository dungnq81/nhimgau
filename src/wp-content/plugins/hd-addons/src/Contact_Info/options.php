...
<div class="section section-text" id="section_hotline">
    ...
    <div class="option">
        <div class="controls">
            <input value="<?php echo esc_attr( $hotline ); ?>" class="input" type="text" id="contact_info_hotline"
                   name="contact_info_hotline">
        </div>
    </div>
</div>
...
<div class="section section-text" id="section_phones">
    ...
    <div
        class="desc"><?php _e( 'The contact phone number, you may input multiple numbers, separated by <b>"comma"</b>.', ADDONS_TEXT_DOMAIN ) ?></div>
    <div class="option">
        <div class="controls">
...
<div class="section section-text" id="section_emails">
    ...
    <div
        class="desc"><?php _e( 'Email contact address, with the ability to enter multiple addresses, with each address separated by a <b>"comma"</b>.', ADDONS_TEXT_DOMAIN ) ?></div>
    <div class="option">
        <div class="controls">
...
<div class="section section-text" id="section_others">
    ...
    <div class="option">
        <div class="controls">
            <textarea class="textarea codemirror_html" name="contact_info_others" id="contact_info_others"
                      rows="4"><?php echo $contact_info_others; ?></textarea>
        </div>
    </div>
</div>
