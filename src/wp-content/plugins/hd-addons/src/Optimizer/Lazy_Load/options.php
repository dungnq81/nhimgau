...
<div class="section section-checkbox" id="section_lazyload">
    ...
    <div
        class="desc"><?php _e( 'Speed up your web application by deferring the loading of below-the-fold images, animated SVGs, videos, and iframes until they enter the viewport.', ADDONS_TEXT_DOMAIN ) ?></div>
    <div class="option">
        <div class="controls">
...
<div class="section section-checkbox !hide" id="section_lazyload_mobile">
    ...
    <div class="option">
        <div class="controls">
            <input type="checkbox" class="checkbox" name="lazy_load_mobile"
                   id="lazy_load_mobile" <?php echo checked( $lazy_load_mobile, 1 ); ?> value="1" />
        </div>
        <div class="explain"><?php _e( 'Check to activate', ADDONS_TEXT_DOMAIN ); ?></div>
    </div>
</div>
...
<div class="section section-textarea" id="section_exclude_lazyload">
    ...
    <div
        class="desc"><?php _e( 'The keywords include <b>file-name</b>, <b>CSS classes</b> of images or <b>iframe</b> codes that will be excluded.', ADDONS_TEXT_DOMAIN ); ?></div>
    <div class="option">
        <div class="controls">
