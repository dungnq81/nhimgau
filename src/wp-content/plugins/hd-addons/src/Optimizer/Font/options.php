...
<div class="section section-checkbox" id="section_font_optimize">
    ...
    <div
        class="desc"><?php _e( 'Optimize the loading of default <b>Google fonts</b>, as well as all <b>other fonts</b> used on your website.', ADDONS_TEXT_DOMAIN ) ?></div>
    <div class="option">
        <div class="controls">
            <input type="checkbox" class="checkbox" name="font_optimize" id="font_optimize" <?php echo checked( $font_optimize, 1 ); ?>
                   value="1">
        </div>
...
<div class="section section-checkbox !hide" id="section_font_combined_css">
    ...
    <div class="option">
        <div class="controls">
            <input type="checkbox" class="checkbox" name="font_combined_css"
                   id="font_combined_css" <?php echo checked( $font_combined_css, 1 ); ?> value="1">
        </div>
        <div class="explain"><?php _e( 'Check to activate', ADDONS_TEXT_DOMAIN ); ?></div>
    </div>
</div>
