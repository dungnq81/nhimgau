...
?>
    ...
    <div class="section section-checkbox" id="section_gzip">
        ...
        <div
            class="desc"><?php _e( 'Enables compression of the content delivered to visitors\' browsers, improving the network loading times of your site.', ADDONS_TEXT_DOMAIN ); ?></div>
        <div class="option">
            <div class="controls">
    ...
    <div class="section section-checkbox" id="section_browser_caching">
        ...
        <div
            class="desc"><?php _e( 'Adds rules to store the static content of your site in visitors\' browser cache for a longer period, improving site performance.', ADDONS_TEXT_DOMAIN ); ?></div>
        <div class="option">
            <div class="controls">
                <input type="checkbox" class="checkbox" name="browser_caching"
                       id="browser_caching" <?php echo checked( $browser_caching, 1 ); ?> value="1">
            </div>
            <div class="explain"><?php _e( 'Check to activate', ADDONS_TEXT_DOMAIN ); ?></div>
        </div>
    </div>
