...
<div class="section section-checkbox" id="section_minify_html">
    ...
    <div
        class="desc"><?php _e( 'Remove unnecessary characters from your HTML output to reduce data size and improve your site\'s loading speed.', ADDONS_TEXT_DOMAIN ); ?></div>
    <div class="option">
        <div class="controls">
...
<div class="section section-textarea" id="section_dns_prefetch">
    ...
    <div
        class="desc"><?php _e( 'Enabling DNS pre-fetch for a domain will resolve it before resources are requested from it, resulting in faster loading of those resources.', ADDONS_TEXT_DOMAIN ); ?></div>
    <div class="option">
        <div class="controls">
