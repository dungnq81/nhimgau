	...
	foreach ( $post_types as $post_type ) {
        ...
        <div class="option mb-20">
            <label class="controls">
                <input type="checkbox" class="checkbox" name="order_post_type[]"
                       value="<?php echo esc_attr( $post_type->name ); ?>" <?php in_array_checked( $order_post_type, $post_type->name ); ?>>
            </label>
...
<div class="section section-checkbox" id="section_custom_taxonomy_order">
	...
	foreach ( $taxonomies as $taxonomy ) {
        ...
        <div class="option mb-20">
            <label class="controls">
                <input type="checkbox" class="checkbox" name="order_taxonomy[]"
                       value="<?php echo esc_attr( $taxonomy->name ); ?>" <?php in_array_checked( $order_taxonomy, $taxonomy->name ); ?>>
            </label>
            <div class="explain"><?php echo $label; ?></div>
        </div>
	<?php } ?>
