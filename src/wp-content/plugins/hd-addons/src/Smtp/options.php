...
<div class="section section-text" id="section_smtp_host">
    ...
    <div
        class="desc"><?php _e( 'The SMTP server which will be used to send email. For example: <b>smtp.gmail.com</b>', ADDONS_TEXT_DOMAIN ); ?></div>
    <div class="option">
        <div class="controls">
...
<div class="section section-select" id="section_smtp_auth">
    ...
    <div
        class="desc"><?php _e( 'Whether to use SMTP Authentication when sending an email (recommended: <b>True</b>).', ADDONS_TEXT_DOMAIN ); ?></div>
    <div class="option">
        <div class="controls">
...
<div class="section section-text" id="section_smtp_password">
    ...
    <div
        class="desc"><?php _e( 'Your SMTP Password (The saved password is not shown for security reasons. If you do not want to update the saved password, you can leave this field empty when updating other options).', ADDONS_TEXT_DOMAIN ); ?></div>
    <div class="option">
        <div class="controls">
...
<div class="section section-select" id="section_smtp_encryption">
    ...
    <div
        class="desc"><?php _e( 'The encryption which will be used when sending an email (recommended: <b>TLS</b>).', ADDONS_TEXT_DOMAIN ); ?></div>
    <div class="option">
        <div class="controls">
            <div class="select_wrapper">
...
<div class="section section-text" id="section_smtp_port">
    ...
    <div
        class="desc"><?php _e( 'The port which will be used when sending an email <b>(587/465/25)</b>. If you choose <b>TLS</b>, it should be set to <b>587</b>. For <b>SSL</b>, use port <b>465</b> instead.', ADDONS_TEXT_DOMAIN ); ?></div>
    <div class="option">
        <div class="controls">
...
<div class="section section-text" id="section_smtp_from_email">
    ...
    <div
        class="desc"><?php _e( 'The email address which will be used as the <b>From Address</b> if it is not supplied to the mail function.', ADDONS_TEXT_DOMAIN ); ?></div>
    <div class="option">
        <div class="controls">
            <input value="<?php echo esc_attr( $smtp_from_email ); ?>" class="input" type="text" id="smtp_from_email"
...
<div class="section section-text" id="section_smtp_from_name">
    ...
    <div
        class="desc"><?php _e( 'The name which will be used as the <b>From Name</b> if it is not supplied to the mail function.', ADDONS_TEXT_DOMAIN ); ?></div>
    <div class="option">
        <div class="controls">
...
<div class="section section-checkbox" id="section_smtp_force_from_address">
    ...
    <div class="option">
        <div class="controls">
            <input type="checkbox" class="checkbox" name="smtp_force_from_address"
                   id="smtp_force_from_address" <?php echo checked( $smtp_force_from_address, 1 ); ?> value="1">
        </div>
        <div
            class="explain"><?php _e( 'The From address in the settings will be set for all outgoing email messages.', ADDONS_TEXT_DOMAIN ); ?></div>
    </div>
</div>

<div class="section section-checkbox" id="section_smtp_disable_ssl_verification">
    <label class="heading"
           for="smtp_disable_ssl_verification"><?php _e( 'Disable SSL Certificate Verification', ADDONS_TEXT_DOMAIN ); ?></label>
    <div class="option">
        <div class="controls">
            <input type="checkbox" class="checkbox" name="smtp_disable_ssl_verification"
                   id="smtp_disable_ssl_verification" <?php echo checked( $smtp_disable_ssl_verification, 1 ); ?> value="1">
        </div>
        <div
            class="explain"><?php _e( 'You should get your host to fix the SSL configurations instead of bypassing it.', ADDONS_TEXT_DOMAIN ); ?></div>
    </div>
</div>
