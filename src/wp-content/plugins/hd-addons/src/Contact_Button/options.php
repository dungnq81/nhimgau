...
<div class="section section-text" id="section_contact_url">
    ...
    <div class="option">
        <div class="controls">
            <input value="<?php echo esc_attr( $contact_url ); ?>" class="input" type="url" id="contact_url" name="contact_url"
                   placeholder="https://">
        </div>
    </div>
</div>
<div class="section section-checkbox" id="section_contact_button_window">
    <div class="option" style="padding-top: 15px;">
        <div class="controls">
            <label><input type="checkbox" class="checkbox" name="contact_window"
                          id="contact_window" <?php echo checked( $contact_window, 1 ); ?> value="1"></label>
        </div>
...
<div class="section section-textarea" id="section_contact_popup_content">
    ...
    <div class="option">
        <div class="controls">
            <textarea class="textarea" name="contact_popup_content" id="contact_popup_content"
                      rows="4"><?php echo $contact_popup_content; ?></textarea>
        </div>
    </div>
</div>
<div class="section section-text" id="section_contact_button_waiting_time">
    ...
    <div class="option">
        <div class="controls">
            <input value="<?php echo esc_attr( $contact_waiting_time ); ?>" class="input" type="number" min="0" id="contact_waiting_time"
                   name="contact_waiting_time">
        </div>
    </div>
</div>
<div class="section section-text" id="section_contact_show_repeat">
    ...
    <div class="option">
        <div class="controls">
            <input value="<?php echo esc_attr( $contact_show_repeat ); ?>" class="input" type="number" min="0" id="contact_show_repeat"
                   name="contact_show_repeat">
        </div>
    </div>
</div>
