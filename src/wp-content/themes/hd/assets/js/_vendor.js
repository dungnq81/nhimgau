...
class part {
  ...
  prepend(compo2) {
    const ns = this.ns, el = this[ns];
    return !!el.prependChild(compo2[ns]);
  }
  /**
...
class SocialShare extends base {
  ...
  generator() {
    ...
    compo2.setAttr("data-social-share", "");
    if (opts.label) {
      const { label: labelParams, locale: locale2 } = opts;
