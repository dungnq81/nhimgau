					...
					foreach ( $r->posts as $recent_post ) :
                        ...
                        <li>
							<?php if ( $show_thumbnail && $post_thumbnail ) : ?>
                                <a class="block cover" href="<?php the_permalink( $recent_post->ID ); ?>"
                                   aria-label="<?php echo $attr_post_title; ?>">
                                    <span class="res <?= $ratio_class ?>"><?php echo $post_thumbnail; ?></span>
                                </a>
							<?php endif; ?>
                            <div class="cover-content">
                                <a href="<?php the_permalink( $recent_post->ID ); ?>"
                                   title="<?php echo $attr_post_title; ?>" <?php echo $aria_current; ?>><?php echo $post_title; ?></a>
