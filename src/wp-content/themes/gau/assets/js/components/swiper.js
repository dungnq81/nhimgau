...
"use strict";
/*!*****************************************************************!*\
  !*** ./wp-content/themes/gau/resources/js/components/swiper.js ***!
  \*****************************************************************/
__webpack_require__.r(__webpack_exports__);
...
var initializeSwiper = function initializeSwiper(el, swiper_class, options) {
  if (!(el instanceof Element)) {
    console.error('Error: The provided element is not a DOM element.');
    return;
  }
  var swiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_1__["default"](swiper_class, options);
...
var generateClasses = function generateClasses() {
  var rand = (0,nanoid__WEBPACK_IMPORTED_MODULE_2__.nanoid)(9);
  return {
    rand: rand,
...
var initializeSwipers = function initializeSwipers() {
  var _document;
  var swiperElements = _toConsumableArray((_document = document) === null || _document === void 0 ? void 0 : _document.querySelectorAll('.w-swiper'));
  swiperElements.forEach(function (el, index) {
    var _el$closest;
    var classes = generateClasses();
    el.classList.add(classes.swiperClass);
    var controls = (_el$closest = el.closest('.swiper-section')) === null || _el$closest === void 0 ? void 0 : _el$closest.querySelector('.swiper-controls');
    if (!controls) {
      controls = document.createElement('div');
      controls.classList.add('swiper-controls');
      el.after(controls);
    }
    var swiperWrapper = el === null || el === void 0 ? void 0 : el.querySelector('.swiper-wrapper');
    var options = JSON.parse(swiperWrapper.dataset.options) || {};
    if ((0,lodash__WEBPACK_IMPORTED_MODULE_0__.isEmpty)(options)) {
      options = {
        autoview: !0,
        autoplay: !0,
        navigation: !0
    ...
    var swiperOptions = _objectSpread({}, getDefaultOptions());
    if (options.autoview) {
    ...
    if (options.effect) {
      swiperOptions.effect = (0,lodash__WEBPACK_IMPORTED_MODULE_0__.toString)(options.effect);
    ...
    if (options.direction) swiperOptions.direction = (0,lodash__WEBPACK_IMPORTED_MODULE_0__.toString)(options.direction);
    ...
    swiperOptions.speed = options.speed ? parseInt(options.speed) : (0,lodash__WEBPACK_IMPORTED_MODULE_0__.random)(300, 900);
    if (options.autoplay) {
      swiperOptions.autoplay = {
        disableOnInteraction: !1,
        delay: options.delay ? parseInt(options.delay) : (0,lodash__WEBPACK_IMPORTED_MODULE_0__.random)(3000, 6000)
      };
    ...
    if (options.navigation) {
      ...
      var btnPrev = section === null || section === void 0 ? void 0 : section.querySelector('.swiper-button-prev');
      var btnNext = section === null || section === void 0 ? void 0 : section.querySelector('.swiper-button-next');
      if (btnPrev && btnNext) {
    ...
    if (options.pagination) {
      ...
      var pagination = _section === null || _section === void 0 ? void 0 : _section.querySelector('.swiper-pagination');
      if (pagination) {
      ...
      var paginationType = options.pagination;
      swiperOptions.pagination = _objectSpread(_objectSpread(_objectSpread(_objectSpread({
    ...
    if (options.scrollbar) {
      ...
      var scrollbar = _section2 === null || _section2 === void 0 ? void 0 : _section2.querySelector('.swiper-scrollbar');
      if (scrollbar) {
...
// Products slides
//
var spgSwipers = function spgSwipers() {
  var _document2;
  var swiperElements = _toConsumableArray((_document2 = document) === null || _document2 === void 0 ? void 0 : _document2.querySelectorAll('.swiper-product-gallery'));
  swiperElements.forEach(function (el, index) {
    var classes = generateClasses();
    el.classList.add(classes.swiperClass);
    var w_images = el === null || el === void 0 ? void 0 : el.querySelector('.swiper-images');
    var w_thumbs = el === null || el === void 0 ? void 0 : el.querySelector('.swiper-thumbs');
    var swiper_images = false;
    var swiper_thumbs = false;

    /** wpg thumbs */
    if (w_thumbs) {
      w_thumbs === null || w_thumbs === void 0 || w_thumbs.querySelector('.swiper-button-prev').classList.add('prev-thumbs-' + classes.rand);
      w_thumbs === null || w_thumbs === void 0 || w_thumbs.querySelector('.swiper-button-next').classList.add('next-thumbs-' + classes.rand);
      w_thumbs.classList.add('thumbs-' + classes.rand);
      var thumbs_options = _objectSpread({}, getDefaultOptions());
    ...
    /** wpg images */
    if (w_images) {
      w_images === null || w_images === void 0 || w_images.querySelector('.swiper-button-prev').classList.add('prev-images-' + classes.rand);
      w_images === null || w_images === void 0 || w_images.querySelector('.swiper-button-next').classList.add('next-images-' + classes.rand);
      w_images.classList.add('images-' + classes.rand);
      var images_options = _objectSpread({}, getDefaultOptions());
    ...
    /** Variation image */
    var firstImage = w_images === null || w_images === void 0 ? void 0 : w_images.querySelector('.swiper-images-first img');
    firstImage.removeAttribute('srcset');
    var firstImageSrc = firstImage.getAttribute('src');
    var imagePopupSrc = w_images === null || w_images === void 0 ? void 0 : w_images.querySelector('.swiper-images-first .image-popup');

    /** */
    var firstThumb = false;
    var firstThumbSrc = false;
    var dataLargeImage = false;
    if (swiper_thumbs) {
      firstThumb = w_thumbs === null || w_thumbs === void 0 ? void 0 : w_thumbs.querySelector('.swiper-thumbs-first img');
